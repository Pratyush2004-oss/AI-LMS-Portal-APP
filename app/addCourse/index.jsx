    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.inputWrapper}>
                <TextInput value={inputValue} onChangeText={(value) => setinputValue(value)} placeholder='Ex: Learn Web Development' numberOfLines={3} multiline={true} style={styles.inputText} />
